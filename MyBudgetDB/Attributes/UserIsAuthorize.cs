...
namespace MyBudgetDB.Attributes
{
    public class UserIsAuthorize : IActionFilter
    {
        ...
        public UserIsAuthorize(ApplicationDbContext _context, UserService userService)
        {
    ...
    public class UserIsAuthorizeAttribute : TypeFilterAttribute
    {
        public UserIsAuthorizeAttribute()
